...
the example below I chose 5 shares for my portfolio. The following
shares were used at the beginning: GIS, SPGI, WMT, GE, PFE. You can
replace the shares with any other shares you like. For more information
visit \url{https://finance.yahoo.com/}. There you can also find the
symbols of different shares.
...
Ratio}\tabularnewline
\toprule()
GIS & PFE & SPGI & WMT & Return & Risk & SharpeRatio \\
\midrule()
\endfirsthead
\toprule()
GIS & PFE & SPGI & WMT & Return & Risk & SharpeRatio \\
\midrule()
\endhead
0,3 & 0,2 & 0,1 & 0,4 & 0,117 & 0,16 & 0,729 \\
\bottomrule()
\end{longtable}
...
\midrule()
\endhead
0 & 0,2 & 0,7 & 0,1 & 0,235 & 0,214 & 1,094 \\
\bottomrule()
\end{longtable}
